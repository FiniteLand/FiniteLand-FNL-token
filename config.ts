...
const FNL_INITIAL_SUPPLY = 1000000 * 10**18; // 1_000_000 tokens(with 18 decimals)

export default {
	FNL_NAME: 'FNL Token',
	FNL_SYMBOL: 'FNL',
	FNL_INITIAL_SUPPLY: FNL_INITIAL_SUPPLY.toString(), 
	...
	// map к каждой сети
	'bsc_testnet': {
		FNL_ADDRESS: '0x25eF370518F625153F7cFAD7cde97A4d4a2eE888',
		HNR_ADDRESS: '0x48573C722920B615E57945D202a605A7bDf42bEf',
	...
	rinkeby: {
		FNL_ADDRESS: '0xDC2DE46a65d91963d1315f4F19CCCB00844d97ef',
		HNR_ADDRESS: '0xff439FFE8E23618917f8Aaa1e4909aF331aF7995',
